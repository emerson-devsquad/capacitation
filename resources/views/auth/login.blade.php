    ...
    <x-auth-card>
        <x-slot name="logo">
            <a href="/">
                <div class="sm:mx-auto sm:w-full sm:max-w-md">
                    <x-application-logo class="mx-auto h-20 w-auto fill-current text-indigo-500" />
                </div>
            </a>
        </x-slot>
        ...
        <form method="POST" action="{{ route('login') }}" class="space-y-6">
            ...
            <div>
                ...
                <x-input id="email" type="email" name="email" autocomplete="email" :value="old('email')" autofocus 
